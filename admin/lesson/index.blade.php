...
$active = "Lessons";
$li = [
[  "قائمة الدروس" , route('lesson.index')],
[ 'اضافة' , route('lesson.create')],
        ...
        <table class="datatable datatable-bordered datatable-head-custom table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end"> الداره
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <a href="/lesson/{{$Lesson->slug}}" target="_blank" class="menu-link px-3">عرض</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="{{ route('lesson.edit' , $Lesson)  }}" class="menu-link px-3">تعديل</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a data-id="{{$Lesson->id}}" data-title="{{$Lesson->title}}" data-action="{{ route('lesson.destroy',$Lesson) }}" data-bs-toggle="modal" data-bs-target="#deleteModel" class="menu-link px-3">مسح</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                        <!--end::Menu-->
...
@include('admin.lesson.create' , ['id' => 'create_Lesson' ,'title' => 'درس' , 'route' => route('lesson.store') ])
