...
$title = 'قائمة الدروس';
$active = 'الدروس';
$li = [['Lessons', route('lesson.index')], ['تعديل', '#']];
@endphp
            ...
            <div class="modal-body scroll-y m-5">
                ...
                <div class="stepper stepper-links d-flex flex-column" id="kt_create_account_stepper">
                    ...
                    <form class="mx-auto mw-600px w-100 py-10 send-ajax" id="kt_create_account_form" method="post"
                        enctype="multipart/form-data" action="{{ route('lesson.update', $lesson) }}">
                        ...
                        <div class="current row" data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" class="form-control form-control-lg form-control-solid" name="slug"
                                        placeholder="slug" value="{{ $lesson->slug }}" />
                                    <!--end::Input-->
                                </div>
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" class="form-control form-control-lg form-control-solid" name="title"
                                        placeholder="title" value="{{ $lesson->title }}" />
                                    <!--end::Input-->
                                </div>
                                    ...
                                    <select name="section_id" class="form-select" data-control="select2"
                                        ...
                                        @foreach (App\Models\Section::select('title', 'id')->get() as $key => $item)
                                            <option value="{{ $item->id }}"
                                                {{ $lesson->sestion_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->title }}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Input-->
                            ...
                            <div class="w-100">
                                <img src="{{ $lesson->imageUrl }}" class="h-75px img-fluid">
                            </div>
                        ...
                        <div data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="url" class="form-control form-control-lg form-control-solid" name="link"
                                        value="{{ $lesson->link }}" />
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <select class="form-select" name="type" data-control="select2"
                                        data-placeholder="Select an option">
                                        @foreach(['vimeo' => 'vimeo', 'youtube' => 'youtube'] as $key => $item)
                                            <option value="{{ $key }}"
                                                {{ $lesson->sestion_id == $key ? 'selected' : '' }}>{{ $item }}
                                            </option>
                                        @endforeach
                                    </select>
                                    <!--end::Input-->
                                ...
                                <div class="mb-10 fv-row">
                                    <!--begin::Label-->
                                    <label class="form-label mb-3"> ترتيب الفديو </label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" class="form-control form-control-lg form-control-solid"
                                        name="index" value="{{ $lesson->index }}" />
                        ...
                        <div data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <textarea name="body" class="tox-target tinymce">
                                    {!! $lesson->body !!} 
                                    </textarea>
