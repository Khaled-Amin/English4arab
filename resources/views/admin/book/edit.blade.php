...
$title = 'قائمة الكتب';
$active = 'الكتب';
$li = [['الكتب', route('book.index')], ['تعديل', '#']];
@endphp
            ...
            <div class="modal-body scroll-y m-5">
                ...
                <div class="stepper stepper-links d-flex flex-column" id="kt_create_account_stepper">
                    ...
                    <form class="mx-auto mw-600px w-100 py-10 send-ajax" id="kt_create_account_form" method="post"
                        enctype="multipart/form-data" action="{{ route('book.update', $get_id->id) }}">
                        ...
                        <div class="current row" data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" class="form-control form-control-lg form-control-solid" name="title"
                                        placeholder="title" value="{{ $get_id->title }}" />
                                    <!--end::Input-->
                                </div>
                                    ...
                                    <select name="section_id" class="form-select" data-control="select2"
                                        ...
                                        @foreach (App\Models\Section::select('title', 'id')->get() as $key => $item)
                                            <option value="{{ $item->id }}"
                                                {{ $get_id->sestion_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->title }}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Input-->
                            ...
                            <div class="w-100">
                                <img src="{{ $get_id->imageUrl }}" class="h-75px img-fluid">
                            </div>
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <select class="form-select" name="type" data-control="select2"
                                        ...
                                        @foreach(['vimeo' => 'vimeo', 'youtube' => 'youtube' , 'pdf' => 'pdf'] as $key => $item)
                                            <option value="{{ $key }}"
                                                {{ $get_id->sestion_id == $key ? 'selected' : '' }}>{{ $item }}
                                            </option>
                                        @endforeach
                                    </select>
                                    <!--end::Input-->
