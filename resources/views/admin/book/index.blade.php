...
$active = "الكتب";
$li = [
[ 'الكتب' , route('book.index')],
[ 'انشاء' , route('book.create')],
                    ...
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <a href="/lesson/{{$Lesson->id}}" target="_blank" class="menu-link px-3">عرض</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="{{ route('book.edit' , $Lesson)  }}" class="menu-link px-3">تعديل</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a data-id="{{$Lesson->id}}" data-title="{{$Lesson->title}}" data-action="{{ route('book.destroy',$Lesson) }}" data-bs-toggle="modal" data-bs-target="#deleteModel" class="menu-link px-3">مسح</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                        <!--end::Menu-->
...
@include('admin.book.create' , ['id' => 'create_Lesson' ,'title' => 'كتاب' , 'route' => route('book.store') ])
