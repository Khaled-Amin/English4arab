...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/sigma-1/14.png">
        ...
        <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
            <!--begin::Logo-->
            <a  class="mb-12">
                <img alt="Logo" src="{{ settings('logo')->value }}" class="h-40px" />
            </a>
            <!--end::Logo-->
            <!--begin::Wrapper-->
...
<script src="/adminassets/plugins/global/plugins.bundle.js"></script>
<script src="/adminassets/js/scripts.bundle.js"></script>
<!--end::Global Javascript Bundle-->
<!--begin::Page Custom Javascript(used by this page)-->
<script src="/adminassets/js/custom/authentication/sign-in/general.js"></script>
